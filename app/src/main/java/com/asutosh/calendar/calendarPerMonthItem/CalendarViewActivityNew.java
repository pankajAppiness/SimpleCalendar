...
public class CalendarViewActivityNew extends AppCompatActivity {
...
//        custCalendarView.setDisabledDay(CustomCalendarView.Days.FRIDAY);
        ...
        custCalendarView.setOnDateSelectedListener(new CustomCalendarView.OnDateSelected() {
            ...
            public void onSelected(Calendar calendar) {
                Toast.makeText(CalendarViewActivityNew.this,"selected---"+calendar.get(Calendar.DAY_OF_MONTH),Toast.LENGTH_LONG).show();
            }
        });
    }
}
